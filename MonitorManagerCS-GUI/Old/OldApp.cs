...
{
    internal static class VCPCodes
    {
        // Settings (VCP codes)
    ...
    internal static class OldApp
    {
        ...
        public static void SetMonitorValue(string monitorID, string vcpCode, string value)
        {
            ...
            Programs.RunProgram(Programs.controlMyMonitor, $"/SetValueIfNeeded {monitorID} {vcpCode} {value}");
        }
    }

    internal class OldMainWindow
    {
        ...
        private void StartMonitorService()
        {
            ...
            monitorServiceTask = Task.Run(() => { OldApp.MonitorService(settings, monitorServiceTokenSource.Token); });
        }
